    ...
    >
      ...
      <div className="absolute bottom-0 mb-5 text-white">
        <p className="font-light">
          In the face of adversity, hope shines brightest. Let us be your beacon
          of hope, providing not just data but a source of inspiration,
          encouragement, and solidarity. Together, we are stronger than cancer.
        </p>
      </div>
    </div>
  );
